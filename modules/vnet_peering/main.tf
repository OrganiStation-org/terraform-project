variable "primary_resource_group" { type = string }
variable "secondary_resource_group" { type = string }
variable "primary_vnet_name" { type = string }
variable "secondary_vnet_name" { type = string }
